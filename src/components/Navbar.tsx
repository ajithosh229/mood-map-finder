        ...
        <div className="flex items-center gap-2">
          {user ? (
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-sm font-medium text-primary hover:text-foreground transition-colors px-3 py-1.5 rounded-lg hover:bg-secondary"
            >
